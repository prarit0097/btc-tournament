...
REQUIRED_FILES = [
    "btc_tournament/config.py",
    "btc_tournament/storage.py",
    "btc_tournament/features.py",
    "btc_tournament/models_zoo.py",
    "btc_tournament/tournament.py",
    "btc_tournament/registry.py",
    "btc_tournament/run_hourly.py",
    "btc_tournament/predict.py",
    "btc_tournament/README.md",
]
...
def check_structure(base: Path) -> CheckResult:
    ...
    for rel in REQUIRED_FILES:
        ...
        if not path.exists():
            missing.append(rel)
    data_fetcher = base / "btc_tournament" / "data_fetcher.py"
    data_sources = base / "btc_tournament" / "data_sources.py"
    if not data_fetcher.exists() and not data_sources.exists():
        missing.append("btc_tournament/data_fetcher.py OR btc_tournament/data_sources.py")
    if missing:
